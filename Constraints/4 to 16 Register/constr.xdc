...
set_property PACKAGE_PIN V10 [get_ports {addr[3]}]
set_property PACKAGE_PIN U12 [get_ports {addr[1]}]
set_property PACKAGE_PIN U11 [get_ports {addr[2]}]
set_property PACKAGE_PIN H6 [get_ports {addr[0]}]
